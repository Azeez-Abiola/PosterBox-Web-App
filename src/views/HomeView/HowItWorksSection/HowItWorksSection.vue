<template>
  <section class="py-20 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 relative">
            ...
            <div class="flex items-start space-x-4 group">
              <div class="flex-shrink-0 w-12 h-12 bg-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-lg transform group-hover:scale-110 transition-transform duration-300">
                2
              </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
        ...
        <div class="space-y-8 scroll-animate-left">
          ...
          <div class="space-y-6">
            <!-- Step 1 -->
            <div class="flex items-start space-x-4 group">
              <div class="flex-shrink-0 w-12 h-12 bg-red-600 rounded-xl flex items-center justify-center text-white font-bold text-lg transform group-hover:scale-110 transition-transform duration-300">
                1
              </div>
              <div class="flex-1 pt-2">
        ...
        <div class="space-y-8 scroll-animate-right">
          ...
          <div class="space-y-6">
            ...
            <!-- Step 2 -->
            <div class="flex items-start space-x-4 group">
              <div class="flex-shrink-0 w-12 h-12 bg-emerald-600 rounded-xl flex items-center justify-center text-white font-bold text-lg transform group-hover:scale-110 transition-transform duration-300">
                2
              </div>
              <div class="flex-1 pt-2">
